...
import annualReport2017 from "../assets/ANNUAL REPORT 2017-2018.pdf";
import annualReport2018 from "../assets/ANNUAL REPORT 2018-2019.pdf";
import annualReport2019 from "../assets/ANNUAL REPORT 2019-2020.pdf";
...
const financialDocuments: FinancialDocument[] = [
  {
    ...
    description:
      "A consolidated view of KSS programs, impact highlights, organizational updates, and yearly reporting.",
    year: "2022–23",
    category: "Annual report",
    status: "Available",
    pdf: annualReport2022,
    fileName: "KSS-Annual-Report-2022-2023.pdf",
    icon: FileBarChart,
  },
  {
    title: "Annual Report 2021–2022",
    description:
      "Program and institutional reporting for the financial year, including progress across thematic areas.",
    year: "2021–22",
    category: "Annual report",
    status: "Available",
    pdf: annualReport2021,
    fileName: "KSS-Annual-Report-2021-2022.pdf",
    icon: FileBarChart,
  },
  {
    title: "Annual Report 2020–2021",
    description:
      "A year-end record of initiatives, field learnings, partner work, and organization-level updates.",
    year: "2020–21",
    category: "Annual report",
    status: "Available",
    pdf: annualReport2020,
    fileName: "KSS-Annual-Report-2020-2021.pdf",
    icon: FileBarChart,
  },
  {
    title: "Annual Report 2019–2020",
    description:
      "Public annual reporting document covering program performance and organizational accountability.",
    year: "2019–20",
    category: "Annual report",
    status: "Available",
    pdf: annualReport2019,
    fileName: "KSS-Annual-Report-2019-2020.pdf",
    icon: FileBarChart,
  },
  {
    title: "Annual Report 2018–2019",
    description:
      "Archived annual report for reference, partner review, and institutional documentation.",
    year: "2018–19",
    category: "Annual report",
    status: "Available",
    pdf: annualReport2018,
    fileName: "KSS-Annual-Report-2018-2019.pdf",
    icon: FileBarChart,
  },
  {
    title: "Annual Report 2017–2018",
    description:
      "Archived annual report documenting KSS’s programs and organizational journey for the year.",
    year: "2017–18",
    category: "Annual report",
    status: "Available",
    pdf: annualReport2017,
    fileName: "KSS-Annual-Report-2017-2018.pdf",
    icon: FileBarChart,
  },
  {
    title: "Audited Financial Statement",
    description:
      "Audited statements and detailed account summaries can be shared with partners and donors on request.",
    year: "Latest",
    category: "Audit",
    status: "On request",
    icon: ClipboardCheck,
  },
  {
    ...
    description:
      "Project-wise utilization certificates and donor-specific financial documents are available through request.",
    year: "Project-wise",
...
const transparencyPillars = [
  {
    ...
    description:
      "We maintain required registrations, records, and documentation to support accountable operations.",
  },
  {
    icon: PieChart,
    title: "Responsible fund use",
    description:
      "Resources are planned, tracked, and reviewed so they remain aligned with community priorities.",
  },
  {
    icon: FileCheck2,
    title: "Audited records",
    description:
      "Financial records are documented for review and can be shared with eligible stakeholders as needed.",
  },
];

const trustPoints = [
  "Annual reports available for review",
  "Audit documents shared on request",
  "Grant records maintained project-wise",
  "Compliance-first financial culture",
];

const Financials = () => {
  const [requestedDocument, setRequestedDocument] = useState("Audited Financial Statement");
  const [requesterName, setRequesterName] = useState("");
  const [requesterEmail, setRequesterEmail] = useState("");
  const [requestMessage, setRequestMessage] = useState("");

  const requestHref = useMemo(() => {
    const subject = encodeURIComponent(`Financial document request: ${requestedDocument || "Specific document"}`);
    const body = encodeURIComponent(
      [
        "Hello Kosi Seva Sadan team,",
        "",
        `I would like to request the following financial document: ${requestedDocument || "Specific document"}.`,
  ...
  return (
    <main className="overflow-hidden bg-[#f7f8f4] text-[#18322e]">
      <section
        ...
        aria-labelledby="financials-page-title"
      >
        ...
        <div className="relative z-10 w-full max-w-[1240px]">
          ...
          <p className="mb-4 inline-flex items-center gap-2 text-xs font-extrabold uppercase tracking-[0.16em] text-[#f4c77f]">
            <BarChart3 size={15} /> Financial transparency
          </p>
          <h1
            id="financials-page-title"
            className="max-w-[920px] font-['Manrope'] text-5xl font-bold leading-[0.98] tracking-[-0.055em] sm:text-6xl lg:text-7xl xl:text-8xl"
          >
            Financial records that build
            <span className="block text-[#f4b860]">trust and accountability.</span>
          </h1>
          <p className="mt-7 max-w-2xl text-base leading-7 text-white/75 sm:text-lg sm:leading-8">
            Explore annual reports, accountability practices, and request financial
            documents that support partner review, donor due diligence, and public trust.
          </p>
      ...
      <section className="mx-auto grid max-w-[1240px] gap-12 px-5 py-20 sm:px-8 sm:py-24 lg:grid-cols-[0.9fr_1.1fr] lg:items-center lg:gap-20 lg:py-32">
        <div>
          ...
          <h2 className="font-['Manrope'] text-4xl font-bold leading-tight tracking-[-0.045em] text-[#173b35] sm:text-5xl lg:text-6xl">
            Clear financial practice helps good work go further.
          </h2>
          <p className="mt-6 text-base leading-8 text-[#63756f]">
            For an NGO, financial transparency is not just accounting—it is a promise
            to communities, donors, partners, and public institutions. KSS keeps
            records that support responsible planning, program delivery, statutory
          ...
          <div className="relative overflow-hidden rounded-[1.8rem] bg-[#173b35] shadow-[0_24px_70px_rgba(23,59,53,0.16)]">
            ...
            <div className="absolute bottom-0 left-0 max-w-xl p-6 text-white sm:p-9">
              ...
              <p className="mt-4 font-['Manrope'] text-2xl font-bold leading-tight tracking-[-0.035em] sm:text-3xl">
                Financial records help partners understand how resources become
                services, safeguards, and community outcomes.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-[1240px]">
          <div className="grid gap-8 lg:grid-cols-[0.9fr_1fr] lg:items-end">
            <div>
              ...
              <h2 className="font-['Manrope'] text-4xl font-bold leading-tight tracking-[-0.045em] text-[#173b35] sm:text-5xl lg:text-6xl">
                The systems behind responsible stewardship.
              </h2>
            </div>
            <p className="max-w-xl text-base leading-8 text-[#687a74] lg:justify-self-end">
              These practices help KSS maintain confidence across grant management,
              internal controls, donor reporting, and community-facing accountability.
            </p>
          </div>

          <div className="mt-12 grid gap-5 md:grid-cols-3">
            {transparencyPillars.map(({ icon: Icon, title, description }) => (
              <article
                key={title}
                className="rounded-[1.35rem] border border-[#dfe8e4] bg-[#f9fbf8] p-6 transition duration-300 hover:-translate-y-2 hover:border-[#f4b860]/70 hover:bg-white hover:shadow-[0_24px_60px_rgba(23,59,53,0.12)]"
              >
                <div className="mb-7 flex h-14 w-14 items-center justify-center rounded-2xl bg-[#173b35] text-[#f4b860]">
      ...
      <section id="financial-documents" className="bg-[#f7f8f4] px-5 py-20 sm:px-8 sm:py-24 lg:py-32">
        <div className="mx-auto max-w-[1240px]">
          <div className="grid gap-8 lg:grid-cols-[0.9fr_1fr] lg:items-end">
            <div>
              <p className="mb-3 text-xs font-extrabold uppercase tracking-[0.15em] text-[#d85a3b]">
              ...
              <h2 className="font-['Manrope'] text-4xl font-bold leading-tight tracking-[-0.045em] text-[#173b35] sm:text-5xl lg:text-6xl">
                Browse available financial documents.
              </h2>
            </div>
            <p className="max-w-xl text-base leading-8 text-[#687a74] lg:justify-self-end">
              Annual reports are available for immediate viewing and download.
              Audit-specific documents can be requested for review where appropriate.
            </p>
          </div>

          <div className="mt-12 grid gap-5 md:grid-cols-2 xl:grid-cols-4">
            {financialDocuments.map(({ icon: Icon, title, description, year, category, status, pdf, fileName }) => (
              <article
                key={title}
                className="group relative flex min-h-[350px] flex-col overflow-hidden rounded-[1.35rem] border border-[#dfe8e4] bg-white p-6 transition duration-300 hover:-translate-y-2 hover:border-[#f4b860]/70 hover:shadow-[0_24px_60px_rgba(23,59,53,0.12)]"
              >
                ...
                <p className="text-xs font-extrabold uppercase tracking-[0.14em] text-[#d85a3b]">
                  {year}
                </p>
                <h3 className="mt-3 font-['Manrope'] text-xl font-bold tracking-[-0.025em] text-[#173b35]">
                  {title}
                </h3>
                ...
                {pdf ? (
                  ...
                  <a
                    href="#request-financial-doc"
                    onClick={() => setRequestedDocument(title)}
        ...
        <div className="relative mx-auto grid max-w-[1240px] gap-12 lg:grid-cols-[0.85fr_1.15fr] lg:items-start lg:gap-20">
          <div>
            <p className="mb-3 inline-flex items-center gap-2 text-xs font-extrabold uppercase tracking-[0.15em] text-[#f4b860]">
              <HandCoins size={15} /> Financial document request
            </p>
            <h2 className="font-['Manrope'] text-4xl font-bold leading-tight tracking-[-0.045em] sm:text-5xl lg:text-6xl">
              Need a specific financial record?
            </h2>
            <p className="mt-6 max-w-xl text-base leading-8 text-white/70">
              Use this request form for audit statements, project-wise utilization
              certificates, grant records, or other financial documents needed for
              due diligence and partner review.
            </p>
            ...
            <div className="grid gap-5 md:grid-cols-2">
              <label className="block">
                ...
                <input
                  ...
                  placeholder="e.g. Audit statement, UC, grant report"
              ...
              <label className="block md:col-span-2">
                ...
                <textarea
                  ...
                  placeholder="Share the financial year, project, donor requirement, or purpose of request."
                  rows={5}
